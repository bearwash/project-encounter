...
function StylizedPlazaAvatarImpl({
  ...
  const palette = useMemo(() => {
    const merged = {
        ...(isSelfPlayer
          ? {
              ...
              face: 'focus',
              detail: 'plain',
              accessory: { kind: 'headphones', color: '#F1F0E3' },
            }
          : basePalette),
        ...appearanceOverrides,
    ...
    return {
      ...merged,
      ...(highDetailHair ? GENERATED_HEAD_PRESETS[merged.hairShape] : {}),
    } satisfies PlazaPalette;
  }, [appearanceOverrides, basePalette, highDetailHair, isSelfPlayer]);
