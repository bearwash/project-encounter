...
`encounter-ble:allow-checkPermissions`
...
`encounter-ble:deny-checkPermissions`
...
`encounter-ble:deny-registerListener`
...
`encounter-ble:allow-removeListener`
...
`encounter-ble:deny-removeListener`
...
`encounter-ble:allow-requestPermissions`
...
`encounter-ble:deny-requestPermissions`
